# Fase ciega de la 71 (copia de .v68aud/cruce_clases.py con las rutas cambiadas): comprueba que cada par sin orden de .v71aud/vecinos_tabla.txt tiene su fila en
# .v71aud/mis_clases.tsv y cada fila su par, y cuenta las clases con su suma (R7). Solo lee.
...
c = collections.Counter(f[2] for f in filas)
print('clases: %s | suma: %d' % (dict(c), sum(c.values())))
