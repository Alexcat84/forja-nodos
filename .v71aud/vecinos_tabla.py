# Fase ciega de la 71 (copia de .v68aud/vecinos_tabla.py con la lista cambiada a los 20 de cap_07 y cap_10 a cap_14, y la suma de cada reparto, R7): lee los .v71aud/vecinos_<id>.json que escribio .v71aud/barrido_uno.py y publica
