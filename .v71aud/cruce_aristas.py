# Fase ciega de la 71 (copia de .v68aud/cruce_aristas.py con las rutas cambiadas): para cada arista por lectura de .v71aud/aristas_lectura.tsv, si el barrido levanto el par
