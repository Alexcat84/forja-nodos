# -*- coding: utf-8 -*-
"""Barrido D.38.4 de la fase ciega de la 71 (copia de .v68aud/barrido_uno.py con la ruta cambiada): la ficha de
...
No escribe nada fuera de .v71aud/."""
import io, json, sys
sys.path.insert(0, '.')
...
json.dump(salida, io.open('.v71aud/vecinos_%s.json' % i, 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
