# -*- coding: utf-8 -*-
"""Fase ciega de la 71 (copia de .v68aud/restricciones_orden.py con la tanda cambiada): las restricciones de orden que MI
lectura pone a la insercion de las 20, escritas antes de ver el orden del extractor. (a) madre antes que hijo (D.29, D.36)
por mis CONTINUA de .v71aud/mis_clases.tsv y mis SOSTENGO de .v71aud/aristas_lectura.tsv con los dos extremos en la tanda;
...
.v71aud/los20.txt (esa lista va por capitulo y alfabetica): lo tomo por capitulo y primera linea de mi fidelidad
(.v71aud/fidelidad_fuente.txt). Solo lee."""
import io, re, sys, collections
sys.stdout.reconfigure(encoding="utf-8")
tanda = [l.strip() for l in io.open('.v71aud/los20.txt', encoding='utf-8') if l.strip()]
...
for f in [l.rstrip('\n').split('\t') for l in io.open('.v71aud/mis_clases.tsv', encoding='utf-8')][1:]:
