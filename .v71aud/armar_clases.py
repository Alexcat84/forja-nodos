# -*- coding: utf-8 -*-
"""Fase ciega de la 71 (copia de .v68aud/armar_clases.py sin la fuente sellada de la 66, que aqui no hay): arma
.v71aud/mis_clases.tsv, una fila por par sin orden que levanta mi barrido de los 20 (.v71aud/vecinos_<id>.json), con la clase
que YO escribi: de .v71aud/clases_intra.txt (pares dentro de un mismo capitulo, escritos antes de mirar el barrido) o de
.v71aud/clases_fuera.txt (pares entre capitulos de la tanda o con un extremo fuera, leidos al recogerlo). Solo escribe ese
...
with io.open('.v71aud/mis_clases.tsv', 'w', encoding='utf-8', newline='\n') as o:
