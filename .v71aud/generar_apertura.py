# Fase ciega de la 71 (copia de .v68aud/generar_apertura.py con la ruta cambiada): arma docs/loop/APERTURA_CIEGA.md desde .v71aud/apertura_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v71aud/apertura_plantilla.md', encoding='utf-8'):
