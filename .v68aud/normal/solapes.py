# -*- coding: utf-8 -*-
"""ACTA 67 (copia de .v67aud/normal/solapes.py): inicio y fin de cada insertar de la 68, de la primera y ultima linea con fecha de cada .v68ext/insertar_*.txt,
y si alguno arranco antes de que acabara el anterior."""
import glob, io, re, datetime
F = '%Y-%m-%d %H:%M:%S'; r = []
for f in sorted(glob.glob('.v68ext/insertar_*.txt')):
