# ACTA 67 (copia de .v67aud/normal/banda_muestra.py): la muestra pineada de los SANO de la 68 (semilla 68, .v68aud/normal/muestra_sano.py), su tasa y su banda de Wilson al 95.
# Y D.8: ningun SANO de la vuelta sin razon escrita.
import json, math
L = [json.loads(l) for l in open("bitacora/VEREDICTOS.jsonl", encoding="utf-8")][893:]
