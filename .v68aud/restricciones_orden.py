# Fase ciega de la 68 (copia de .v66aud/restricciones_orden.py con la tanda cambiada): las restricciones de orden que MI lectura pone a la insercion de cap_05 y cap_06, escritas antes de
