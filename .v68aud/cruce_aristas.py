# Fase ciega de la 68 (copia de .v66aud/cruce_aristas.py con las rutas cambiadas): para cada arista por lectura de .v68aud/aristas_lectura.tsv, si el barrido levanto el par
