# Fase ciega de la 68 (copia de .v66aud/generar_apertura.py con la ruta cambiada): arma docs/loop/APERTURA_CIEGA.md desde .v68aud/apertura_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v68aud/apertura_plantilla.md', encoding='utf-8'):
