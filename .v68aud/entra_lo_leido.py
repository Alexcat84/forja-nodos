# -*- coding: utf-8 -*-
"""Fase ciega de la 68 (copia de .v67aud/entra_lo_leido.py con la tanda cambiada). Para las filas 21 y 22 de cap_04
(agrupar_interrupciones y canalizar, las dos que la 67 dejo a la 68), y con TANDA=22 para las 22 de cap_04 enteras:
...
import sys
tanda = los22 if sys.argv[1:] == ['22'] else ['agrupar_interrupciones_subordinados_reuniones_regulares',
