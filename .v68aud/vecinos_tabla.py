# Fase ciega de la 68 (copia de .v66aud/vecinos_tabla.py con la lista cambiada a las filas 21 y 22 y los 20 de cap_05 y cap_06): lee los .v68aud/vecinos_<id>.json que escribio .v68aud/barrido_uno.py y publica
...
orden = ['agrupar_interrupciones_subordinados_reuniones_regulares', 'canalizar_interrupciones_cartel_hora_oficina'] + tanda
filas = []; pares = collections.OrderedDict(); falta = []
print('(1) candidato | poblacion | vecinos | en grafo | en bandeja')
for i in orden:
    f = '.v68aud/vecinos_%s.json' % i
