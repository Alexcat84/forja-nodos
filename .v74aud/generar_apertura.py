# Fase ciega de la 74 (copia de .v73aud/generar_apertura.py con la ruta cambiada): arma docs/loop/APERTURA_CIEGA.md desde .v74aud/apertura_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v74aud/apertura_plantilla.md', encoding='utf-8'):
