# -*- coding: utf-8 -*-
"""Corre UN `python forja.py insertar` de la vuelta 68, filas 21 y 22 (COPIA de .v67ext/insertar.py, que era COPIA de .v66ext/insertar.py) y espera a que vuelva.

    python .v68ext/insertar.py <fila> <id>

Lo que cambia de la copia, y se dice: las lineas --veredicto se copian TAL CUAL de su bloque `## <id>` de
.v66ext/veredictos_listos.txt (encargo de la 68, TAREA 2.2; en la 67 era su TAREA 4.1), que es el fichero de los 22 de cap_04 con las correcciones de la
...
Escribe .v68ext/insertar_<fila>_<id>.txt con el comando, la salida entera, el codigo y el reloj,
y al final el marcador .v68ext/insertar_<fila>_<id>.fin. No toca nada mas.
"""
...
for l in lineas:
    cmd += ['--veredicto', l]
base = '.v68ext/insertar_%s_%s' % (fila, cid)
t0 = time.time()
