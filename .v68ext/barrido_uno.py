# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 68 de .v66ext/barrido_uno.py (que era COPIA de .v65aud/barrido_uno.py), con la ruta de
...
json.dump(salida, io.open('.v68ext/vecinos_%s.json' % i, 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
