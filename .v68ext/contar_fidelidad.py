# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 68 de .v66ext/contar_fidelidad.py, con la ruta cambiada a .v68ext/fidelidad.tsv y el rotulo a los 20
de cap_05 y cap_06; nada mas cambiado.
...
filas = [[c.strip() for c in l.rstrip('\n').split('|')]
         for l in io.open('.v68ext/fidelidad.tsv', encoding='utf-8') if l.strip() and not l.startswith('#')]
...
print()
print('PASOS INVENTADOS POR CAPITULO, los 20 de cap_05 y cap_06 (COPIA de la vuelta 68 de .v66ext/contar_fidelidad.py, ruta cambiada)')
