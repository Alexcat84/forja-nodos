# -*- coding: utf-8 -*-
"""Fase ciega de la 73 (copia de .v71aud/armar_clases.py con las rutas cambiadas): arma
.v73aud/mis_clases.tsv, una fila por par sin orden que levanta mi barrido de las 7 (.v73aud/vecinos_<id>.json), con la clase
que YO escribi: de .v73aud/clases_intra.txt (pares dentro de un mismo capitulo, escritos antes de mirar el barrido) o de
.v73aud/clases_fuera.txt (pares entre capitulos de la tanda o con un extremo fuera, leidos al recogerlo). Solo escribe ese
...
ab = {}; fuente = {}
for l in io.open('.v73aud/clases_intra.txt', encoding='utf-8'):
    if l.startswith('@'):
