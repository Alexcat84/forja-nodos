# Fase ciega de la 73 (copia de .v72aud/generar_apertura.py con la ruta cambiada): arma docs/loop/APERTURA_CIEGA.md desde .v73aud/apertura_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v73aud/apertura_plantilla.md', encoding='utf-8'):
