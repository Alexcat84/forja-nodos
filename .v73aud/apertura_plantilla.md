...
@@RUN:0::python .v73aud/huella_acta.py@@
...
@@RUN:0::grep -c -E "previos|siguientes" .v73aud/pasos_*.txt@@
@@RUN:0::grep -l -E "previos|siguientes" .v73aud/*.py .v73aud/*.sh | wc -l@@
...
@@RUN:0::wc -l < .v73aud/los7.txt; ls cuarentena/grove_high_output | sed 's/\.json$//' | diff - .v73aud/los7.txt && echo "los7.txt es la bandeja de Grove entera, fichero a fichero"@@
@@RUN:0::python .v72aud/normal/siete.py | diff - .v72aud/normal/siete.txt && echo "siete.py de hoy: IDENTICO a su salida de la ACTA 71 71.1"; tail -2 .v72aud/normal/siete.txt@@
...
@@RUN:0::python .v73aud/huellas_contra_71.py@@
...
@@RUN:0::python .v73aud/cobertura.py@@
...
@@RUN:0::wc -l fuentes/grove_high_output/cap_1[5-7].md@@
...
@@RUN:0::python .v73aud/contar_fidelidad.py@@
...
@@RUN:0::python .v73aud/correcciones.py | grep -c "^====="; python .v73aud/correcciones.py | grep "^=====" | sed 's/^===== //'@@
...
@@RUN:0::head -1 .v73aud/barrido.log; tail -1 .v73aud/barrido.log; grep -c "rc=0" .v73aud/barrido.log; grep -c "rc=" .v73aud/barrido.log@@
@@RUN:0::wc -l < .v73aud/huellas_al_barrer.txt; sha1sum -c --quiet .v73aud/huellas_al_barrer.txt && echo "las 49 fichas de las tres bandejas y el grafo: mismas huellas que al barrer"@@

**Poblacion y vecinos por candidato, cada fila de vecino con su senial, y los pares sin orden:**

@@RUN:0::python .v73aud/vecinos_tabla.py | tee .v73aud/vecinos_tabla.txt@@
...
@@RUN:0::grep "rc=" .v73aud/barrido.log | sed 's/.*segundos=//' | sort -n | sed -n '1p;$p'@@
...
@@RUN:0::python .v73aud/armar_clases.py@@
@@RUN:0::python .v73aud/cruce_clases.py@@

**El par de `cap_15` que el encargo manda mirar con direccion**, con los pasos de los dos delante:

@@RUN:0::python .v67aud/normal/pasos_ciego.py responder_primer_aviso_renuncia_subordinado gestionar_retencion_subordinado_valioso_renuncia@@
...
@@RUN:0::python .v73aud/cruce_aristas.py@@
...
@@RUN:0::python .v73aud/temas.py | tee .v73aud/temas.txt | grep -v "^    "@@
...
@@RUN:0::python .v73aud/restricciones_orden.py@@
...
@@RUN:0::python .v72aud/normal/r8_encargo73.py | diff - .v72aud/normal/r8_encargo73.txt && echo "IDENTICO a .v72aud/normal/r8_encargo73.txt, la salida de la ACTA 71 71.12"; python .v72aud/normal/r8_encargo73.py | tail -1@@
...
@@RUN:0::grep -n -i -w -E "dos|tres|cuatro|cinco|seis|siete|ocho|nueve|diez|once|doce|veinte|cero" docs/loop/PROMPT_SIGUIENTE.md | cut -c1-150@@
...
@@RUN:0::python .v73aud/r7_pagina.py@@
