# -*- coding: utf-8 -*-
"""Barrido D.38.4 de la fase ciega de la 73 (copia de .v71aud/barrido_uno.py con la ruta cambiada): la ficha de
...
No escribe nada fuera de .v73aud/."""
import io, json, sys
sys.path.insert(0, '.')
...
json.dump(salida, io.open('.v73aud/vecinos_%s.json' % i, 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
