# -*- coding: utf-8 -*-
"""Fase ciega de la 73: imprime, de cada ficha de la bandeja de Grove, los tramos de su resumen_teorico que empiezan por
...
for f in sorted(glob.glob('cuarentena/grove_high_output/*.json')):
    ...
    for m in re.finditer(r'CORRECCION DECLARADA', r):
        print('=====', os.path.basename(f)[:-5]); print(r[m.start():m.start() + 1500]); print()
