# Fase ciega de la 73 (copia de .v71aud/cruce_clases.py con las rutas cambiadas): comprueba que cada par sin orden de .v73aud/vecinos_tabla.txt tiene su fila en
# .v73aud/mis_clases.tsv y cada fila su par, y cuenta las clases con su suma (R7). Solo lee.
