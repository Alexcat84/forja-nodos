# Fase ciega de la 73 (copia de .v71aud/cruce_aristas.py con las rutas cambiadas): para cada arista por lectura de .v73aud/aristas_lectura.tsv, si el barrido levanto el par
