# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 66 de .v65ext/pasos_inventados.py: la tanda es la de las filas 21 y 22 de .v65ext/orden.txt, que
son las que entraron en la 66 (encargo, TAREA 4). Lo demas, como estaba.
PASOS INVENTADOS POR CAPITULO sobre lo que ENTRO, contado desde las
...
tanda = [l.split()[1] for l in io.open('.v65ext/orden.txt', encoding='utf-8') if re.match(r'^\d+\s', l)][20:22]
