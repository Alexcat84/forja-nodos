# -*- coding: utf-8 -*-
"""R5 por el otro lado: en el tramo de la vuelta 66 de REPORTE.md (copia de la vuelta 66 de .v64aud/normal/bloques_mudos.py, cabecera cambiada), cada bloque indentado que
...
i0 = [k for k, l in enumerate(L) if l.startswith('# VUELTA 66 ')][0]
bloques, cur = [], None
