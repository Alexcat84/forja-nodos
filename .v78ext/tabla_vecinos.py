# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 78 de .v76ext/tabla_vecinos.py, con las rutas cambiadas a .v78ext/ y la lista a .v78ext/lista_barrido.txt
(la misma forma que la de la 76). Nada mas. Lo que decia la de la 76: COPIA DE LA VUELTA 76 de .v73ext/tabla_vecinos.py, con las rutas cambiadas a .v76ext/ y la lista a
...
import io, json
for l in io.open('.v78ext/lista_barrido.txt', encoding='utf-8').read().splitlines():
