# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 78 de .v76ext/contar_fidelidad.py, con la ruta cambiada a .v78ext/fidelidad.tsv, a
cuarentena/marquet_turn_the_ship/ y a fuentes/marquet_turn_the_ship/, y el rotulo a las 20 de Marquet; nada mas cambiado. Lo que decia la
de la 76: COPIA DE LA VUELTA 76 de .v73ext/contar_fidelidad.py, con la ruta cambiada a .v76ext/fidelidad.tsv y a
...
for i, m in por_id.items():
    ...
    cap[i] = re.search(r'fuentes/marquet_turn_the_ship/(cap_\d+)\.md', d['resumen_teorico']).group(1)
...
print()
print('PASOS INVENTADOS POR CAPITULO, las 20 de Marquet (COPIA de la vuelta 78 de .v76ext/contar_fidelidad.py, ruta cambiada)')
peor = []
