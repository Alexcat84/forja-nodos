#!/bin/bash
# COPIA DE LA VUELTA 78 de .v76ext/barrer.sh, con la ruta cambiada a .v78ext/ en las dos lineas de trabajo y nada mas (las 20 de
# Marquet, .v78ext/lista_barrido.txt, las 20 primeras lineas de .v78ext/bandeja.txt, con el id en la segunda columna). Lo que decia la de la 76:
# COPIA DE LA VUELTA 76 de .v73ext/barrer.sh, con la ruta cambiada a .v76ext/ en las dos lineas de trabajo y nada mas (las 22 de
# Gerber, .v76ext/lista_barrido.txt, las 22 primeras lineas de .v76ext/bandeja.txt, con el id en la segunda columna). Lo que decia la de la 73: COPIA DE LA VUELTA 73 de .v71ext/barrer.sh,
# con la ruta cambiada a .v73ext/. Lo que decia la de la 71:
...
grep -v '^#' "$1" | awk 'NF{print $2}' | xargs -P 5 -I{} bash -c '
  t0=$(date +%s); python .v78ext/barrido_uno.py {} > .v78ext/barrido_{}.txt 2>&1; rc=$?; t1=$(date +%s)
