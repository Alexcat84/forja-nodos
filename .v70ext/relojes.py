# -*- coding: utf-8 -*-
"""El reloj de los 20 insertar de la vuelta 70 (copia de .v67ext/relojes.py, ruta cambiada), leido de la ultima linea de cada .v70ext/insertar_*.txt."""
import glob, io, re
s = []
for f in sorted(glob.glob('.v70ext/insertar_*.txt')):
