# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 70 de .v68ext/aristas_vuelta.py (encargo, TAREA 4): las aristas que la vuelta 70 dejo en
bitacora/VEREDICTOS.jsonl (lineas 905 en adelante; la 904 era la ultima al abrir, 70.0), y las que siguen EN COLA
porque un extremo espera en la bandeja. Comprueba que cada arista cableada vive en el grafo (madre con el hijo en
nodos_siguientes), y la cruza con las ESPERADAS: las CONTINUA con madre= de las filas 1 a 20 de .v69ext/orden.txt en
.v68ext/veredictos_listos.txt (sin las lineas #) y las SOSTENGO de .v68ext/aristas_lectura.txt cuyo hijo esta en esas filas."""
import io, json, re
L = [json.loads(l) for l in io.open('bitacora/VEREDICTOS.jsonl', encoding='utf-8') if l.strip()][904:]
