# -*- coding: utf-8 -*-
# Copia de la vuelta 70 de .v64ext/pegado64.py con la cabecera del tramo cambiada a la vuelta 70 (encargo, TAREA 5).
...
i = [k for k, l in enumerate(lineas) if l.startswith('# VUELTA 70 ')][0]
tramo = lineas[i:]
...
print('bloques abiertos con `$` en el tramo de la vuelta 70 : %d' % total)
