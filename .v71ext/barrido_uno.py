# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 71 de .v68ext/barrido_uno.py, con la ruta de escritura cambiada a .v71ext/ y nada mas; lee la
...
json.dump(salida, io.open('.v71ext/vecinos_%s.json' % i, 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
