# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 71 de .v69ext/comprobar_veredictos.py, con las rutas cambiadas de .v68ext a .v71ext y la lista a las
...
for f in sorted(glob.glob('.v71ext/vecinos_*.json')):
    d = json.load(io.open(f, encoding='utf-8'))
    hoy[d['id']] = set(v['id'] for v in d['vecinos'])
los22 = [l.split()[1] for l in io.open('.v71ext/los20.txt', encoding='utf-8') if l.strip() and not l.startswith('#')]
