# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 71 de .v68ext/contar_fidelidad.py, con la ruta cambiada a .v71ext/fidelidad.tsv, el rotulo a las 20
...
filas = [[c.strip() for c in l.rstrip('\n').split('|')]
         for l in io.open('.v71ext/fidelidad.tsv', encoding='utf-8') if l.strip() and not l.startswith('#')]
...
print()
print('PASOS INVENTADOS POR CAPITULO, las 20 de cap_07 a cap_14 (COPIA de la vuelta 71 de .v68ext/contar_fidelidad.py, ruta cambiada)')
peor = []
