...
<!-- TALLADO: salida=.v59ext/d006_fuente_tres_nodos.txt -->
...
| `P2` | introduce variacion si la pregunta no saca respuestas | `L171`: *it's absolutely fine to introduce some variation, particularly if your question isn't eliciting responses* | TRANSCRIPCION |
...
<!-- TALLADO: salida=.v59ext/d006_pasos_releidos.txt -->
...
(la salida literal de las cinco corridas de hoy va pegada mas abajo, en el mismo acto en que se
corrieron)
