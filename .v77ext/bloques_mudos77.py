# -*- coding: utf-8 -*-
"""R5 por el otro lado: en el tramo de la vuelta 77 de REPORTE.md (copia de la vuelta 77 de .v76ext/bloques_mudos76.py, cabecera cambiada; la de la 76 era copia de .v64aud/normal/bloques_mudos.py), cada bloque indentado que
...
i0 = [k for k, l in enumerate(L) if l.startswith('# VUELTA 77 ')][0]
bloques, cur = [], None
