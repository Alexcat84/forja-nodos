# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 77 de .v75ext/aristas_vuelta.py (encargo de la 77, TAREA 4.6). Lo cambiado, y nada mas: la linea de apertura, que es la 1111 (77.0: lo que la vuelta 77 escribio en la bitacora son las lineas 1112 en adelante); las sedes, .v77ext/veredictos_listos.txt y .v77ext/aristas_lectura.txt (las copias de la TAREA 2); la tanda, las filas 1 a 22 de .v76ext/orden.txt; y dos columnas: los DOS LADOS (madre con el hijo en nodos_siguientes E hijo con la madre en nodos_previos) y el veredicto que la arista lleva en la bitacora, para que ninguna quede sin adjudicar. Lo que decia la de la 75: COPIA DE LA VUELTA 75 (encargo de la 75, TAREA 4.4), con la linea de apertura cambiada a la 1081 (75.0: lo que la vuelta 75 escribio en la bitacora son las lineas 1082 en adelante, la 1082 la de corregir de la TAREA 2) y las sedes a .v73ext/ con la tanda de las filas 1 a 7. Lo que decia la de la 72: COPIA DE LA VUELTA 72 de .v70ext/aristas_vuelta.py (encargo de la 72, TAREA 4), con la linea de apertura cambiada a la
...
import io, json, re
L = [json.loads(l) for l in io.open('bitacora/VEREDICTOS.jsonl', encoding='utf-8') if l.strip()][1111:]
