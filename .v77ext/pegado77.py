# -*- coding: utf-8 -*-
# Copia de la vuelta 77 de .v76ext/pegado76.py con la cabecera del tramo cambiada a la vuelta 77 (encargo de la 77, TAREA 5); la de la 76 era copia de .v64ext/pegado64.py.
...
i = [k for k, l in enumerate(lineas) if l.startswith('# VUELTA 77 ')][0]
tramo = lineas[i:]
...
print('bloques abiertos con `$` en el tramo de la vuelta 77 : %d' % total)
