# Fase ciega de la 69 (copia de .v68aud/generar_apertura.py con la ruta cambiada y PYTHONIOENCODING fijado): arma
# docs/loop/APERTURA_CIEGA.md desde .v69aud/apertura_plantilla.md, sustituyendo cada linea @@RUN:<n>:<fichero>:<comando>@@
# por un bloque con '$ <comando>' y la salida LITERAL de correrlo ahora (R5: el bloque contiene lo que el comando imprime
# y nada mas; si n > 0 se corta por el final, dentro del bloque, con '(recortado, entero en <fichero>)'). No escribe nada
# mas que ese fichero.
...
out = []
for l in io.open('.v69aud/apertura_plantilla.md', encoding='utf-8'):
