# -*- coding: utf-8 -*-
"""Fase ciega de la 78 (copia de .v76aud/correcciones.py con el libro cambiado): imprime, de cada ficha de la bandeja de Marquet, los tramos de su resumen_teorico que empiezan por
