# Fase ciega de la 78 (copia de .v76aud/vecinos_tabla.py con la lista cambiada a las 20 de la bandeja de Marquet): lee los .v78aud/vecinos_<id>.json que escribio .v78aud/barrido_uno.py y publica
