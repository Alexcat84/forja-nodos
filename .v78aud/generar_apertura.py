# Fase ciega de la 78 (copia de .v76aud/generar_apertura.py con la ruta cambiada): arma docs/loop/APERTURA_CIEGA.md desde .v78aud/apertura_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v78aud/apertura_plantilla.md', encoding='utf-8'):
