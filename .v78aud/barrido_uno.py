# -*- coding: utf-8 -*-
"""Barrido D.38.4 de la fase ciega de la 78 (copia de .v76aud/barrido_uno.py con la ruta y el libro cambiados): la ficha de
cuarentena/marquet_turn_the_ship/ o, con segundo argumento 'ins', de _insertados, normalizada como la
...
No escribe nada fuera de .v78aud/."""
import io, json, sys
sys.path.insert(0, '.')
from src import aduana, comun, config as modulo_config
i = sys.argv[1]
sede = 'cuarentena/_insertados/marquet_turn_the_ship/' if sys.argv[2:] == ['ins'] else 'cuarentena/marquet_turn_the_ship/'
...
json.dump(salida, io.open('.v78aud/vecinos_%s.json' % i, 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
