# Fase ciega de la 78 (copia de .v77aud/normal/r10.sh sin la linea de CREDITO_serial.jsonl, que el arnes retiro en esta fase), R10: las salidas pegadas en docs/loop/PROMPT_SIGUIENTE.md, vueltas a correr DESPUES de mi ultima escritura en
...
ls -l --time-style=full-iso docs/loop/DEUDA.jsonl docs/loop/PROMPT_SIGUIENTE.md | awk '{print $6, substr($7,1,8), $9}'
