# Fase ciega de la 78 (copia de .v76aud/cruce_clases.py con las rutas cambiadas): comprueba que cada par sin orden de .v78aud/vecinos_tabla.txt tiene su fila en
# .v78aud/mis_clases.tsv y cada fila su par, y cuenta las clases con su suma (R7). Solo lee.
