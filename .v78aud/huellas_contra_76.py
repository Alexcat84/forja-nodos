# -*- coding: utf-8 -*-
"""Fase ciega de la 78, sin git (copia de .v76aud/huellas_contra_73.py con el fichero de huellas cambiado al de la 76): las
huellas que tome al lanzar mi barrido de la 76 (.v76aud/huellas_al_barrer.txt) contra los ficheros de HOY, solo de las fichas
...
print('contra mis huellas de la 76: %s | suma: %d' % (dict(sorted(c.items())), sum(c.values())))
