...
acta (`90457524`), con quien lo escribio:
    ...
    $ git log --format="%h %an %cI %s" 90457524..e92b1f85 | cut -c1-140
    e92b1f85 alexcat84 2026-09-26T16:11:56-04:00 Apertura ciega de la vuelta 2, sellada antes de exponer el reporte
    463248f5 alexcat84 2026-09-26T15:02:37-04:00 Vuelta 78: la salida del hook del commit del cierre
    91bf4863 alexcat84 2026-09-26T15:01:22-04:00 Vuelta 78, T5: el cierre (censo 459, 1172, 1, 20, 0 al abrir y al cerrar; 3 PUENTE marcados y 0
    cc46a0da alexcat84 2026-09-26T14:49:06-04:00 Vuelta 78, T3 y T4: el barrido de las 20 de Marquet (20 de 20, poblacion 479, 52 pares, recogid
    d19671a1 alexcat84 2026-09-26T13:42:08-04:00 Vuelta 78, T1 y T2: los registros de la ACTA 76 y la fidelidad entera de las 20 de Marquet (110
    e9d03092 alexcat84 2026-09-26T13:29:25-04:00 Vuelta 78: lo pendiente del arnes antes de tocar nada
    $ git diff --name-status 90457524 463248f5 | grep -v "\.v78ext/" | awk '{print $1, $NF}' | sed "s|/[^/]*\.json$|/*.json|" | sort | uniq -c
          2 M cuarentena/marquet_turn_the_ship/*.json
          2 M docs/loop/*.json
          1 M docs/loop/loop.log
          1 M docs/loop/REPORTE.md
          1 M docs/loop/TABLERO.jsonl
    $ git diff --name-status 90457524 463248f5 -- .v78ext | awk '{print $1}' | sort | uniq -c; git diff --name-only 463248f5 e92b1f85
         86 A
    docs/loop/APERTURA_CIEGA.md
    docs/loop/SELLOS_APERTURA.jsonl
    $ git log --format="%h %an" 90457524..e92b1f85 -- src tests scripts forja.py config esquema fuentes dataset bitacora censos | wc -l; git diff 90457524 463248f5 -- docs/loop/DEUDA.jsonl | grep -c "^[-+]{"
    0
    0
    $ git diff --stat=200 90457524 463248f5 -- cuarentena/; git diff --stat 90457524 e9d03092 -- docs/loop/TABLERO.jsonl | tail -1; git diff --stat e9d03092 e92b1f85 -- docs/loop/TABLERO.jsonl | wc -l
...
`.v64aud/normal/bloques_mudos.py`, no de las suyas, con la cabecera cambiada a la `78`:
    ...
    $ diff --strip-trailing-cr .v64ext/pegado64.py .v78aud/normal/pegado78_aud.py | grep -c "^>"; diff --strip-trailing-cr .v64aud/normal/bloques_mudos.py .v78aud/normal/bloques_mudos78_aud.py | grep -c "^>"
    3
    2
    $ python .v78aud/normal/pegado78_aud.py; python .v78aud/normal/bloques_mudos78_aud.py
    bloques abiertos con `$` en el tramo de la vuelta 78 : 27
    bloques que ROMPEN R1 (ACTA 60 60.15)                : 0
    bloques abiertos con `$`: 17 | comandos `$`: 27 | comandos sin ninguna linea de salida en su bloque: 0
...
Corridos en serie por `.v78aud/normal/guardas.sh`, cada uno con su `rc`:
    ...
    $ cat .v78aud/normal/gate.txt .v78aud/normal/guiones.txt .v78aud/normal/resolutor.txt
    GATE VERDE.
    ...
    alias registrados: 0
    rc=0
    $ grep 'total:' .v78aud/normal/suite.txt; tail -1 .v78aud/normal/suite.txt; cat .v78aud/normal/suite_hora.txt
      total: 382 pruebas, 0 fallos, 0 errores
    rc=0
    INICIO SUITE 16:14:04
    FIN SUITE 16:18:13
...
**EL CIERRE ESTRICTO, CORRIDO POR MI**, en serie despues de la suite, con `procesos/` vacio al terminar:
    ...
    $ grep -nE '^(CIERRE|CENSO|TALLADO|TABLA DE CIERRE)|DIFIEREN|CAEN  ' .v78aud/normal/cerrar_reporte.txt; tail -1 .v78aud/normal/cerrar_reporte.txt; cat .v78aud/normal/cerrar_hora.txt .v78aud/normal/procesos_al_acabar.txt
    ...
    293:  CAEN                      : 0
    299:CENSO VERDE: las 1090 rutas publicadas sostienen lo que dicen sostener.
...
fichas son byte a byte las de su cierre (`77.4`):
    ...
    $ grep -v '^\$ ' .v78aud/normal/reproduce.txt
    citas.sh: IDENTICO a .v78ext/citas_fidelidad.txt
    r9.py: IDENTICO a .v78ext/r9.txt
    contar_fidelidad.py: IDENTICO a .v78ext/contar_fidelidad.txt
    comprobar_veredictos.py: IDENTICO a .v78ext/comprobar_veredictos.txt
    orden.py: IDENTICO a .v78ext/orden.txt
    tabla_vecinos.py: IDENTICO a .v78ext/tablas_vecinos.md
    pasos_y_huellas.py: IDENTICO a .v78ext/pasos_y_huellas.txt
    censo.sh: IDENTICO a .v78ext/censo_cierre.txt
    validar.py con las 20 ids de su salida: IDENTICO a .v78ext/validar.txt
...
`3`); la suya, el texto de AL ABRIR:
    ...
    $ python .v78aud/normal/fidelidad_cruce.py
    filas: mias 110 | suyas 110 | en las dos: 110 | solo mias: 0 | solo suyas: 0
    marcas: {'mia D / suya T': 2, 'mia T / suya P': 3, 'mia T / suya T': 105} | suma: 110
    lineas: {'linea distinta': 1, 'misma linea': 109} | suma: 110
    filas con marca o linea distinta, o discutible suyo: 12
      asignar_responsable_unico_evolucion_planificada         paso  2 | mia T L127  | suya T L127  | DISCUTIBLE suyo
      auditar_formacion_premios_ultima_fila                   paso  6 | mia D L57   | suya T L57   | DISCUTIBLE suyo
      auditar_formacion_premios_ultima_fila                   paso  8 | mia T L55   | suya T L55   | DISCUTIBLE suyo
      contar_firmas_cadena_tramite_parado                     paso 10 | mia T L43   | suya T L41
      declarar_intencion_reemplazar_peticion_permiso          paso  1 | mia T L75   | suya T L75   | DISCUTIBLE suyo
      eliminar_seguimiento_descendente_responsabilizar_dueno  paso  2 | mia T L73   | suya T L73   | DISCUTIBLE suyo
      informar_cierre_jornada_conservar_propiedad_trabajo     paso  1 | mia T L35   | suya T L35   | DISCUTIBLE suyo
      informar_cierre_jornada_conservar_propiedad_trabajo     paso  2 | mia T L35   | suya P L35   | DISCUTIBLE suyo
      informar_cierre_jornada_conservar_propiedad_trabajo     paso  4 | mia T L35   | suya P L35   | DISCUTIBLE suyo
      recorrer_organizacion_escuchar_plantilla                paso  6 | mia T L15   | suya T L15   | DISCUTIBLE suyo
      seguir_frustrado_preguntar_implantacion_ideas           paso  2 | mia T L25   | suya P L25   | DISCUTIBLE suyo
      seguir_frustrado_preguntar_implantacion_ideas           paso  3 | mia D L27   | suya T L27   | DISCUTIBLE suyo
...
- **Todos los pasos de cada ficha citan el capitulo de su ficha** en mi fichero y en el suyo (`78.2`):
    ...
    $ awk -F'\t' 'NR>1{print $1, $4}' .v78aud/fidelidad.tsv | sort -u | awk '{print $1}' | uniq -c | awk '$1>1' | wc -l; grep -v "^#" .v78ext/fidelidad.tsv | awk -F'|' '{print $4}' | grep -c ":"
    0
    0
...
como dice su cabecera):
    ...
    $ diff <(sed -n '/PAT = re.compile(/,/re.I)/p' .v76ext/r9.py) <(sed -n '/PAT = re.compile(/,/re.I)/p' .v78ext/r9.py) && echo "su patron de la 78: IDENTICO al de la 76"
    su patron de la 78: IDENTICO al de la 76
    $ python .v78aud/normal/r9_cruce.py
    reforzar_principios_guia_lenguaje_prueba_conocimiento paso 2 | solo el mio: prueba | su marca T | su nota: Go out and ask the first three people you see what they are
    pasos: 110 | por patron que casa: {'suyo+mio': 6, 'ninguno': 91, 'suyo': 12, 'mio': 1} | suma: 110
...
**`PASOS INVENTADOS POR CAPITULO`**, contado por mi desde los dos ficheros, con el titulo de cada capitulo leido de su fichero:
    ...
    $ python .v78aud/normal/pasos_inventados.py
    cap_01 | Introduction | candidatos 1 | pasos 6 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    cap_02 | Change of Course | candidatos 2 | pasos 10 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    cap_03 | Call to Action | candidatos 6 | pasos 53 | PUENTE sobre el texto de al abrir 1 = 1.89 por ciento | PUENTE en el texto de hoy 0
    cap_04 | “Whatever They Tell Me to Do!” | candidatos 1 | pasos 5 | PUENTE sobre el texto de al abrir 2 = 40.00 por ciento | PUENTE en el texto de hoy 0
    cap_06 | Change, in a Word | candidatos 2 | pasos 8 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    cap_07 | “I Intend To . . .” | candidatos 1 | pasos 3 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    cap_08 | Up Scope! | candidatos 1 | pasos 5 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    cap_09 | Who's Responsible? | candidatos 1 | pasos 2 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    cap_10 | “We Have a Problem” | candidatos 1 | pasos 3 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    cap_11 | “Mistakes Just Happen!” | candidatos 1 | pasos 3 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    cap_12 | “We Learn” | candidatos 1 | pasos 8 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    cap_13 | All Present and Accounted For | candidatos 1 | pasos 2 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    cap_14 | Leadership at Every Level | candidatos 1 | pasos 2 | PUENTE sobre el texto de al abrir 0 = 0.00 por ciento | PUENTE en el texto de hoy 0
    lote: candidatos 20 | pasos 110 | PUENTE al abrir 3 = 2.73 por ciento | PUENTE hoy 0 | suma de pasos por capitulo: 110
...
**Su barrido contra el mio sellado, fila dirigida a fila dirigida, y sus lineas contra mis clases selladas, par a par:**
    ...
    $ python .v78aud/normal/barrido_cruce.py
    poblacion igual por candidato: {'True': 20} | suma: 20
    filas dirigidas: mias 52 | suyas 52 | {'igual en sede, seniales y quien la levanta': 52} | suma: 52
    sus lineas: 52 | por clase: {'SANO': 52} | suma: 52
    sus lineas contra mis filas dirigidas: iguales en el conjunto: SI
    sus lineas contra mis clases selladas: {'su clase es la mia': 52} | suma: 52 | distintas: []

**Las cifras de prosa de su `78.3`, contadas sobre mi barrido:**

    $ python .v78aud/normal/cifras_reporte.py
    candidatos: {'con vecinos': 16, 'sin vecinos': 4} | suma: 20
    filas dirigidas por similitud_texto y sede: {'<= 0,4, bandeja': 23, '<= 0,4, grafo': 10, '> 0,4, bandeja': 19} | suma: 52
    la mayor: 0.464 tomar_accion_deliberada_pausar_vocalizar_gesticular > acoger_inspectores_externos_fuente_aprendizaje

**Sus aristas por lectura contra las mias selladas, con direccion:**

    $ python .v78aud/normal/aristas_cruce.py
    filas: mias 6 {'SOSTENGO': 1, 'DESCARTO': 5} | suyas 22 {'DESCARTO': 21, 'SOSTENGO': 1}
      aplicar_ejercicio_codigo_genetico_control            > identificar_temas_formacion_tarjetas_decision        | solo mia, DESCARTO
      ceder_control_reforzar_competencia_claridad          > NINGUNO (competencia tecnica y claridad organizativa) | solo mia, DESCARTO
      encargar_meta_especifica_dejar_libre_metodo          > cambiar_forma_trabajar_conservar_plantilla           | solo mia, DESCARTO
      informar_cierre_jornada_conservar_propiedad_trabajo  > eliminar_seguimiento_descendente_responsabilizar_dueno | en las dos, DESCARTO y DESCARTO
      observar_reunion_rutinaria_senales_plantilla         > seguir_frustrado_preguntar_implantacion_ideas        | en las dos, SOSTENGO y SOSTENGO
      recorrer_organizacion_escuchar_plantilla             > contar_firmas_cadena_tramite_parado                  | en las dos, DESCARTO y DESCARTO
    pares: {'solo suya, DESCARTO': 19, 'solo mia, DESCARTO': 3, 'en las dos, DESCARTO y DESCARTO': 2, 'en las dos, SOSTENGO y SOSTENGO': 1} | suma: 25
    SOSTENGO mias: [('observar_reunion_rutinaria_senales_plantilla', 'seguir_frustrado_preguntar_implantacion_ideas')]
    SOSTENGO suyas: [('observar_reunion_rutinaria_senales_plantilla', 'seguir_frustrado_preguntar_implantacion_ideas')]

**Su orden contra mis siete restricciones selladas** (`APERTURA_CIEGA.md` `7`):

    $ python .v78aud/normal/orden_contra_restricciones.py
      observar_reunion_rutinaria_senales_plantilla         (fila  4) antes que seguir_frustrado_preguntar_implantacion_ideas        (fila  5) | la cumple
      seguir_frustrado_preguntar_implantacion_ideas        (fila  5) antes que acoger_inspectores_externos_fuente_aprendizaje       (fila 17) | la cumple
      recorrer_organizacion_escuchar_plantilla             (fila  8) antes que acoger_inspectores_externos_fuente_aprendizaje       (fila 17) | la cumple
      recorrer_organizacion_escuchar_plantilla             (fila  8) antes que auditar_formacion_premios_ultima_fila                (fila  9) | la cumple
      informar_cierre_jornada_conservar_propiedad_trabajo  (fila 10) antes que declarar_intencion_reemplazar_peticion_permiso       (fila 14) | la cumple
      reforzar_principios_guia_lenguaje_prueba_conocimiento (fila 13) antes que declarar_intencion_reemplazar_peticion_permiso       (fila 14) | la cumple
      inspeccionar_reparto_informacion_notas_jefe          (fila  7) antes que recorrer_organizacion_escuchar_plantilla             (fila  8) | la cumple
    filas del orden: 20 | restricciones: {'obliga, la cumple': 1, 'D.36 de un lado, la cumple': 6} | suma: 7
...
**Y las huellas**: las de mi fase ciega, tomadas antes de barrer, y los blobs que su `78.5.c` sella, contra las fichas de hoy:
    ...
    las 20 fichas y el grafo de hoy: mismas huellas que al barrer en mi fase ciega
...
**FUERA DEL MARCADO, SUS DOS FRONTERAS DECLARADAS** (`6.1`, fila *dos doctrinas legitimas*), que su fichero de aristas escribe y no marca:
    ...
    $ grep -n "FRONTERA DECLARADA" .v78ext/aristas_lectura.txt | cut -d'|' -f2,3 | sed 's/^/  /'
       comunicar_valores_diez_formas | repetir_mensaje_invariable_diario_reunion_evento
       delegar_tarea_base_comun_seguimiento | eliminar_seguimiento_descendente_responsabilizar_dueno
...
Al abrir, y despues de anotar mi tanda:
    ...
    $ sed -n '5,11p' .v78aud/normal/credito_abrir.txt
...
## 77.8. **EL COSTE** (`D.55`)
    ...
    $ python .v78aud/normal/coste.py
    ultimo_extractor.json | USD 14.82 | 1275 s de API | turnos 134 | entrada 266 | cache escrita 463239 | cache leida 41348381 | salida 141938 (pensamiento 46461)
    ultimo_apertura.json | USD 10.02 | 951 s de API | turnos 96 | entrada 168 | cache escrita 417030 | cache leida 22735905 | salida 106667 (pensamiento 38246)
    $ grep "extractor listo\|auditor ciego listo" docs/loop/loop.log | tail -2
    [2026-09-26 15:03:20] extractor listo (USD 14.815412200000003), 5664s, intento 1 de 7
    [2026-09-26 16:11:35] auditor ciego listo (USD 10.017433000000004), 4093s, intento 1 de 7
...
| campania consumada | **NO**: faltan las `20` de Marquet | |
    ...
    $ sed -n '11,13p;24p' .v78aud/normal/tablero.txt
...
## 77.12. **`R8` MEDIDO SOBRE MI ENCARGO DE LA `79`, ANTES DE CERRARLO** (`77.11`)
    ...
    $ python .v78aud/normal/r8_encargo79.py | tail -1
