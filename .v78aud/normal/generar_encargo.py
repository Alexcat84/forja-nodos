# ACTA 77 (copia de .v78aud/generar_apertura.py con las rutas cambiadas): arma docs/loop/PROMPT_SIGUIENTE.md desde .v78aud/normal/encargo_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v78aud/normal/encargo_plantilla.md', encoding='utf-8'):
...
io.open('docs/loop/PROMPT_SIGUIENTE.md', 'w', encoding='utf-8', newline='\n').write(''.join(out))
print('escrito docs/loop/PROMPT_SIGUIENTE.md: %d lineas' % sum(o.count('\n') for o in out))
