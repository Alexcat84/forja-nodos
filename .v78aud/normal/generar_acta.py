# ACTA 77 (copia de .v78aud/generar_apertura.py con las rutas cambiadas): arma .v78aud/normal/acta77.md desde .v78aud/normal/acta_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v78aud/normal/acta_plantilla.md', encoding='utf-8'):
...
io.open('.v78aud/normal/acta77.md', 'w', encoding='utf-8', newline='\n').write(''.join(out))
print('escrito .v78aud/normal/acta77.md: %d lineas' % sum(o.count('\n') for o in out))
