# -*- coding: utf-8 -*-
"""Fase ciega de la 78 (copia de .v76aud/r7_pagina.py sin cambios en el codigo), R7 medido sobre la pagina: en docs/loop/APERTURA_CIEGA.md, las lineas de salida de los
