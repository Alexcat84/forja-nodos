# -*- coding: utf-8 -*-
"""Espera en PRIMER PLANO a que un insertar de .v72ext/insertar.py (COPIA DE LA VUELTA 72 de .v70ext/esperar.py, ruta cambiada; la de la 70 era COPIA de .v68ext/esperar.py) deje su marcador .fin.
    python .v72ext/esperar.py <fila> <id> [tope_s]
Sale 0 si termino (e imprime el codigo), 3 si agoto el tope y el insertar sigue vivo."""
import os, sys, time
base = '.v72ext/insertar_%s_%s' % (sys.argv[1], sys.argv[2])
