# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 72 de .v71ext/pasos_y_huellas.py (encargo de la 72, TAREA 2), con el commit de comparacion cambiado a 682a39c,
el cierre del reintento de la 71 (ninguna ficha cambio despues de 3e90afc, ACTA 70 70.1): las 20 fichas tienen que salir iguales
a su blob en 682a39c, y sus 20 filas iguales a las de .v71ext/pasos_y_huellas.txt. Lo demas, la de la 71: COPIA DE LA VUELTA 71 de .v70ext/pasos_y_huellas.py (encargo de la 71, TAREA 5: la huella de las 20 fichas preparadas,
