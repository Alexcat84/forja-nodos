# ACTA 74: los 20 insertar de la 75, por sus ficheros .v75ext/insertar_NN_<id>.txt: codigo de salida, y que ninguno empezo
# antes de que terminara el anterior (inicio de la fila N+1 contra fin de la fila N).
import glob, re
from datetime import datetime
F = sorted(glob.glob('.v75ext/insertar_[0-9][0-9]_*.txt'))
filas = []
for f in F:
