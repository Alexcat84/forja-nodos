# ACTA 74: la muestra pineada de los SANO de la 75 (semilla 75, .v75aud/normal/muestra_sano.py), copia de .v72aud/normal/banda_muestra.py, su tasa y su banda de Wilson al 95.
# Y D.8: ningun SANO de la vuelta sin razon escrita.
import json, math
L = [json.loads(l) for l in open("bitacora/VEREDICTOS.jsonl", encoding="utf-8")][1081:]
