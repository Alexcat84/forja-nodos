# -*- coding: utf-8 -*-
"""Fase ciega de la 75, sin git (copia de .v72aud/huellas_hoy.py con las rutas de la 73): las 50 huellas que tome al
lanzar mi barrido de la 73 (.v73aud/huellas_al_barrer.txt: las fichas de las tres bandejas y el grafo) contra los
...
aqui: lo mide .v75aud/grafo_sin_tanda.py. Reparte por bandeja y por estado, con su suma (R7). Solo lee."""
...
print('movidas a _insertados: %d | son las 7 de .v73aud/los7.txt: %s | fuera de ellas: %s' % (
    len(movidas), 'SI' if movidas == los7 else 'NO', sorted(movidas - los7)))
