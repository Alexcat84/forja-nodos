# Fase ciega de la 75 (copia de .v74aud/generar_apertura.py con la ruta cambiada): arma docs/loop/APERTURA_CIEGA.md desde .v75aud/apertura_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v75aud/apertura_plantilla.md', encoding='utf-8'):
