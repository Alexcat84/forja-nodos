# Fase ciega de la 72 (copia de .v71aud/generar_apertura.py con la ruta cambiada y PYTHONIOENCODING fijado como en .v70aud): arma docs/loop/APERTURA_CIEGA.md desde .v72aud/apertura_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v72aud/apertura_plantilla.md', encoding='utf-8'):
