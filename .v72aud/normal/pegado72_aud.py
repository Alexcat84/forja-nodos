# -*- coding: utf-8 -*-
# Copia del auditor (ACTA 71) de .v64ext/pegado64.py, sacada con sed del original, con la cabecera del tramo cambiada a la vuelta 72.
...
i = [k for k, l in enumerate(lineas) if l.startswith('# VUELTA 72 ')][0]
tramo = lineas[i:]
...
print('bloques abiertos con `$` en el tramo de la vuelta 72 : %d' % total)
