# -*- coding: utf-8 -*-
"""R5 por el otro lado: en el tramo de la vuelta 67 de REPORTE.md (copia de la vuelta 67 de .v64aud/normal/bloques_mudos.py, cabecera cambiada), cada bloque indentado que
