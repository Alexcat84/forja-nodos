...
EL SELLO NO SE ACEPTA: 1 guarda(s) en rojo al sellar.
  la guarda 'censo_rutas' estaba en ROJO en el instante del sello (2026-09-23 07:52:57). Una cifra vale en el instante del sello (D.38.3, 16 sep 2026): si al cerrar hay un rojo, la tabla de cierre no se escribio DESPUES de volver a correr las guardas. 
...
Estado: rama extraccion-mundo-11, hash a4d750a.
