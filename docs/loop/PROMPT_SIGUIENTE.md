# ENCARGO DE LA VUELTA 1 DEL FRENTE `grove_high_output`

*Frente de extraccion en paralelo (`D.45`). **Rama `extraccion-grove_high_output`, carpeta
`../forja-grove_high_output`.** Escrito por el fundador al abrir el paralelo el 16 sep 2026.*
...
| | |
|---|---|
| **NO INSERTAS** | escribes candidatos en `cuarentena/grove_high_output/` y los pasas por la aduana **EN SECO**, en el mismo acto en que los escribes |
...
| unidades en `fuentes/grove_high_output/` | **18** |
| palabras | **64.862** |
| candidatos ya en bandeja | **0** |
| lugar en `ORDEN_DE_LOTES.md` | **7** |

**ABRE EL LIBRO.** La bandeja esta vacia: esta es su vuelta 1.
...
**Y COMMITEA Y PUSHEA A TU RAMA**, `extraccion-grove_high_output`. **No fundas nada**: la cosecha
