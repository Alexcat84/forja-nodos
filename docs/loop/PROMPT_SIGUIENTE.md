# ENCARGO DE LA VUELTA 1 DEL FRENTE `marquet_turn_the_ship`

*Frente de extraccion en paralelo (`D.45`). **Rama `extraccion-marquet_turn_the_ship`, carpeta
`../forja-marquet_turn_the_ship`.** Escrito por el fundador al abrir el paralelo el 16 sep 2026.*
...
| | |
|---|---|
| **NO INSERTAS** | escribes candidatos en `cuarentena/marquet_turn_the_ship/` y los pasas por la aduana **EN SECO**, en el mismo acto en que los escribes |
...
| | |
|---|---:|
| clave | `marquet_turn_the_ship` |
| titulo | Turn the Ship Around! |
| autor | L. David Marquet |
| unidades en `fuentes/marquet_turn_the_ship/` | **17** |
| palabras | **34.217** |
| candidatos ya en bandeja | **3** |
| lugar en `ORDEN_DE_LOTES.md` | **5** |

**CONTINUA, NO ABRE.** Ya tiene **3 candidatos en bandeja** de la vuelta 25 y **2 unidades minadas** (`cap_01` y `cap_02`, con sus dos fronteras cerradas al digito). **Sigue por donde quedo.**
...
**Y COMMITEA Y PUSHEA A TU RAMA**, `extraccion-marquet_turn_the_ship`. **No fundas nada**: la cosecha
