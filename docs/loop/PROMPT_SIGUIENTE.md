...
**Las deudas que paga esta vuelta**, tal como estan en el registro:
    ...
    $ python scripts/deuda.py | grep -E "^  (d098|d099|d104|d135|d150|d180|d183) "
      d098   3       relectura          EL PUNTERO D.37 DE gerber_emyth, ESCRITO PARA QUE NO
      d099   3       relectura          DONDE NACE EL NODO DE LA DELEGACION DE gerber_emyth,
      d104   3       relectura          PUNTERO D.37 DE cap_12: L21 nombra Innovation, Quant
      d135   9       relectura          LOS DOS TRAMOS QUE MAS COMPITEN EN cap_03 NO SON EL
      d150   2       relectura          La TAREA 2 y la TAREA 3 del reporte de la vuelta 1 d
      d180   74      deuda              CUANDO LA BANDEJA DE UN LIBRO COSECHADO QUEDA EN 0 C
