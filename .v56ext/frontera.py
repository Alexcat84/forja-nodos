# -*- coding: utf-8 -*-
"""MI LECTURA DE LA FRONTERA DE cap_08, cap_09 Y cap_10, PUBLICADA ANTES DE MINAR NADA.

Mismo instrumento que la vuelta 55 corrio sobre cap_09 y cap_10 (.v55ext/frontera.py), que a
su vez reusaba el de la vuelta 53 sobre cap_06, cap_07 y cap_08: NI UNA LINEA DE SU MAQUINARIA
TOCADA (EXTRACTOR.md 13, la moratoria de maquinaria). Lo unico que cambia es la TABLA DE
TRAMOS, que es MI lectura de hoy: cap_08 es lectura nueva (no minada antes), y cap_09 y cap_10
las releo ENTERA por mi cuenta esta vuelta (EXTRACTOR.md 5: el instrumento manda, y una nota
vieja no es fuente de una cifra nueva) antes de cerrarlas. Mi relectura de cap_09 y cap_10
coincide tramo a tramo con la de la vuelta 55: la cito como contraste y no como fuente.

CERO CONSTANTES TECLEADAS QUE EL FICHERO PUEDA DAR: la cabecera se localiza buscando el
segundo guion triple, las palabras y los caracteres se cuentan del fichero, y la cita de cada
fila la imprime el instrumento de la linea (D.35: la cita se pega, no se promete). Lo unico
que pongo yo son los TRAMOS, el rotulo de cada uno y los NODOS QUE PREVE, que son mi lectura
y lo que el auditor siguiente recomputa.
...
TRAMOS = {
    "cap_08": [
        ("L9 a L9", 9, 9, 0,
         "P1  rotulo: el numero 7, sin cuerpo que extraer"),
        ("L11 a L11", 11, 11, 0,
         "P2  titulo textual The Breakfast Factory Goes National, sin cuerpo que extraer"),
        ("L13 a L13", 13, 13, 0,
         "P3  la maquina de huevos y el exito que abarata el coste: CASO, continua la fabrica de desayunos, manual 3.5"),
        ("L15 a L15", 15, 15, 0,
         "P4  la franquicia nacional a partir del articulo de la revista: CASO, manual 3.5"),
        ("L17 a L17", 17, 17, 0,
         "P5  la tension entre el conocimiento local y la escala nacional: POSTURA de apertura del capitulo, sin pasos"),
        ("L19 a L19", 19, 19, 0,
         "P6  la dicotomia centralizar o descentralizar con sus preguntas de publicidad, personal y salario: CASO con PREGUNTAS abiertas, manual 3.5, ninguna cerrada en inventario"),
        ("L21 a L21", 21, 21, 0,
         "P7  el compromiso de los centros regionales de compra de huevos y el estandar nacional de calidad: CASO resuelto, manual 3.5, la solucion es del relato y no un medio nombrado para transferir"),
        ("L23 a L23", 23, 23, 0,
         "P8  el menu comun con margen regional: CASO resuelto, manual 3.5"),
        ("L25 a L25", 25, 25, 0,
         "P9  la pregunta de bienes raices, sin resolver: CASO con PREGUNTAS, manual 3.5"),
        ("L27 a L27", 27, 27, 0,
         "P10 muebles y vajilla, con almacenes regionales de reparto: CASO resuelto, manual 3.5"),
        ("L29 a L29", 29, 29, 0,
         "P11 donde ubicar cada nueva franquicia, sin resolver: CASO con PREGUNTAS, manual 3.5"),
        ("L31 a L31", 31, 31, 0,
         "P12 la nostalgia del negocio pequeno y la proliferacion de mandos corporativos: CASO, manual 3.5, el deseo del gerente de trafico de comprar un ordenador no despliega ningun paso"),
        ("L33 a L33", 33, 33, 0,
         "P13 el cierre: la gestion no es solo un juego de equipo, es un equipo de equipos: POSTURA de cierre que anuncia el capitulo siguiente, sin pasos propios"),
    ],
    "cap_09": [
        ("L9 a L11", 9, 11, 0,
...
print("=" * 78)
print("NODOS QUE MI FRONTERA DA EN LAS TRES UNIDADES DE HOY (cap_08+cap_09+cap_10): %d" % total_nodos)
print("  cap_08: %d   cap_09: %d   cap_10: %d"
      % (nodos_por_unidad["cap_08"], nodos_por_unidad["cap_09"], nodos_por_unidad["cap_10"]))
