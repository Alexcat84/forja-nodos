# -*- coding: utf-8 -*-
# Copia de la vuelta 69 de .v64ext/pegado64.py con la cabecera del tramo cambiada a la vuelta 69 (encargo, TAREA 5).
...
i = [k for k, l in enumerate(lineas) if l.startswith('# VUELTA 69 ')][0]
tramo = lineas[i:]
...
print('bloques abiertos con `$` en el tramo de la vuelta 69 : %d' % total)
