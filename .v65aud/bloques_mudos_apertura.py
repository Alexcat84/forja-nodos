# -*- coding: utf-8 -*-
"""R5 por el otro lado: en MI apertura ciega de la 65 entera (copia de .v64aud/normal/bloques_mudos.py con la ruta y el tramo cambiados), cada bloque indentado que
