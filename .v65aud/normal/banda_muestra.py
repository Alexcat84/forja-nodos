# ACTA 64: la muestra pineada de los SANO de la 65 (semilla 65, .v65aud/muestra_sano.py), su tasa y su banda de Wilson al 95.
# Y D.8: ningun SANO de la vuelta sin razon escrita.
import json, math
L = [json.loads(l) for l in open("bitacora/VEREDICTOS.jsonl", encoding="utf-8")][740:]
