# -*- coding: utf-8 -*-
# Copia de .v63aud/pegado63.py con la cabecera del tramo cambiada a la vuelta 65 (ACTA 62 62.13).
...
i = [k for k, l in enumerate(lineas) if l.startswith('# VUELTA 65 ')][0]
tramo = lineas[i:]
...
print('bloques abiertos con `$` en el tramo de la vuelta 65 : %d' % total)
