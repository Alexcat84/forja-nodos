...
print('bloques abiertos con `$` en el tramo de la vuelta 62 : %d' % total)
print('bloques que ROMPEN R1 (ACTA 60 60.15)                : %d' % len(rotos))
for c, m in rotos:
    print('   $ %s\n       %s' % (c, m))
print()
print('CONTROL, y NO es caida: el primer `git hash-object docs/loop/TABLA_DE_CIERRE.txt`')
print('pega 544ddc8d y hoy imprime e0fac5d1 porque el fichero se relevo DESPUES,')
print('dentro de la misma vuelta y declarado en 62.5.a. El segundo reproduce IDENTICO.')
