# -*- coding: utf-8 -*-
"""ACTA 76: R8 (ACTA 72 72.11) medido sobre mi encargo de la 78 (docs/loop/PROMPT_SIGUIENTE.md) ANTES de cerrarlo. Copia de
.v76aud/normal/r8_encargo77.py con la seccion cambiada a la ACTA 76 (`76.N`). Imprime las lineas de prosa con digito o con
...
for n, l in enumerate(io.open('docs/loop/PROMPT_SIGUIENTE.md', encoding='utf-8'), 1):
    ...
    if not nums and not pals:
        ...
        continue
    sec = bool(re.search(r'`76\.\d+`', l))
    c['prosa con numero, %s seccion de la ACTA 76' % ('con' if sec else 'sin')] += 1
