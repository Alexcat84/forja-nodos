# ACTA 76: el coste de los dos turnos de la vuelta 77 contra el umbral de 10 USD (D.55), leido de los json del arnes. Copia de .v76aud/normal/coste.py con la cabecera cambiada. Solo lee.
import json, io
