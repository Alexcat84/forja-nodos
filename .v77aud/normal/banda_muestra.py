# ACTA 76: la muestra pineada de los SANO de la 77 (semilla 77, .v77aud/normal/muestra_sano.py), copia de .v75aud/normal/banda_muestra.py con el corte y n cambiados, su tasa y su banda de Wilson al 95.
# Y D.8: ningun SANO de la vuelta sin razon escrita.
import json, math
L = [json.loads(l) for l in open("bitacora/VEREDICTOS.jsonl", encoding="utf-8")][1111:]
