# Fase ciega de la 77 (copia de .v75aud/generar_apertura.py con la ruta cambiada): arma docs/loop/APERTURA_CIEGA.md desde .v77aud/apertura_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v77aud/apertura_plantilla.md', encoding='utf-8'):
