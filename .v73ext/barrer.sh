#!/bin/bash
# COPIA DE LA VUELTA 73 de .v71ext/barrer.sh, con la ruta cambiada a .v73ext/ en las dos lineas de trabajo y nada mas. Lo que decia la de la 71:
...
grep -v '^#' "$1" | awk 'NF{print $2}' | xargs -P 5 -I{} bash -c '
  t0=$(date +%s); python .v73ext/barrido_uno.py {} > .v73ext/barrido_{}.txt 2>&1; rc=$?; t1=$(date +%s)
