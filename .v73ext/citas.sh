#!/bin/bash
# COPIA DE LA VUELTA 73 de .v71ext/citas.sh, con la ruta cambiada a .v73ext/fidelidad.tsv y nada mas (las 7 de cap_15, cap_16 y
...
done < <(grep -v '^#' .v73ext/fidelidad.tsv)
