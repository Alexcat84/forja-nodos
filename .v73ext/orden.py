# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 73 de .v71ext/orden.py (TAREA 4.3 del encargo de la 73). Lo cambiado, y nada mas: las rutas de .v71ext a
...
L22 = collections.OrderedDict((l.split()[1], (l.split()[0], _pieza(l.split()[1])))
                              for l in io.open('.v73ext/las7.txt', encoding='utf-8') if l.strip() and not l.startswith('#'))
assert sorted(ORDEN) == sorted(L22), 'ORDEN no son las 7'
# madres
...
print()
print('ARISTAS ESPERADAS EN LA VUELTA QUE INSERTE ESTAS 7')
cont = set()
act = None
for l in io.open('.v73ext/veredictos_listos.txt', encoding='utf-8'):
    l = l.rstrip(chr(10))
