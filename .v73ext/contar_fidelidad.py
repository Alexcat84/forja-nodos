...
filas = [[c.strip() for c in l.rstrip('\n').split('|')]
         for l in io.open('.v73ext/fidelidad.tsv', encoding='utf-8') if l.strip() and not l.startswith('#')]
...
print()
print('PASOS INVENTADOS POR CAPITULO, las 7 de cap_15 a cap_17 (COPIA de la vuelta 73 de .v71ext/contar_fidelidad.py, ruta cambiada)')
peor = []
