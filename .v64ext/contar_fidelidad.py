# -*- coding: utf-8 -*-
"""Cuenta la relectura de .v64ext/fidelidad.tsv contra las fichas de la bandeja: cada paso de
...
filas = [[c.strip() for c in l.rstrip('\n').split('|')]
         for l in io.open('.v64ext/fidelidad.tsv', encoding='utf-8') if l.strip() and not l.startswith('#')]
...
print()
print('PASOS INVENTADOS POR CAPITULO, los seis de d005')
