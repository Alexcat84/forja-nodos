# -*- coding: utf-8 -*-
"""Talla la fila del reporte de un insertar de la vuelta 65 desde su salida guardada.
    python .v65ext/fila.py <fila> <id> <commit_de_insercion>"""
import io, re, sys
fila, cid, commit = sys.argv[1:4]
t = io.open('.v65ext/insertar_%s_%s.txt' % (fila, cid), encoding='utf-8').read()
