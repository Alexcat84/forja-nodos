# -*- coding: utf-8 -*-
"""Espera en PRIMER PLANO a que un insertar de .v65ext/insertar.py deje su marcador .fin.
    python .v65ext/esperar.py <fila> <id> [tope_s]
Sale 0 si termino (e imprime el codigo), 3 si agoto el tope y el insertar sigue vivo."""
import os, sys, time
base = '.v65ext/insertar_%s_%s' % (sys.argv[1], sys.argv[2])
