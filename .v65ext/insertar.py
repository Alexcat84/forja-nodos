# -*- coding: utf-8 -*-
"""Corre UN `python forja.py insertar` de la tanda de la vuelta 65 y espera a que vuelva.

    python .v65ext/insertar.py <fila> <id>
...
Escribe .v65ext/insertar_<fila>_<id>.txt con el comando, la salida entera, el codigo y el reloj,
y al final el marcador .v65ext/insertar_<fila>_<id>.fin. No toca nada mas.
"""
...
for l in lineas:
    cmd += ['--veredicto', l]
base = '.v65ext/insertar_%s_%s' % (fila, cid)
t0 = time.time()
