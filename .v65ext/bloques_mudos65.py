# -*- coding: utf-8 -*-
# Copia de .v64aud/normal/bloques_mudos.py con la cabecera del tramo cambiada a la vuelta 65 (ACTA 63 63.11).
"""R5 por el otro lado: en el tramo de la vuelta 65 de REPORTE.md, cada bloque indentado que
...
i0 = [k for k, l in enumerate(L) if l.startswith('# VUELTA 65 ')][0]
bloques, cur = [], None
