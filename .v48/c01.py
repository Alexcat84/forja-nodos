...
d = {
 ...
 "resumen_teorico": (
  ...
  "LA LECCION DE LA ARISTA COLGADA, ESCRITA AQUI PORQUE ESTE NODO ES EL QUE LA PAGA (encargo de la vuelta 48, 2.b): "
  "identificar_paso_limitante_jornada_desfases declaro en la vuelta 47 una arista HIJO hacia el id usar_calendario_herramienta_planificacion_produccion cuando ese id todavia no existia en ninguna sede, y acerto de casualidad. "
  "LAS ARISTAS HACIA NODOS QUE AUN NO EXISTEN SE DECLARAN POR SU TRAMO (el nodo que sale de L289, el nodo que sale de L303) Y NO POR UN ID INVENTADO DE ANTEMANO, porque un id que nadie ha escrito puede no coincidir con el que se escriba, y entonces la arista queda colgada sin que ninguna guarda lo cante: el gate solo mira el grafo. "
  "POR ESO LAS ARISTAS DE ESTA FICHA HACIA NODOS NO ESCRITOS VAN POR SU TRAMO Y NO POR SU ID."
 )
}
