...
print('nodos al abrir: %d | hoy: %d | nuevos: %d | nuevos que son de las 7 filas: %d | viejos que cambian: %d | cambios fuera de nodos_siguientes de una madre y de la TAREA 2: %d'
