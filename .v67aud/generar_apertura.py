# Fase ciega de la 67 (copia de .v66aud/generar_apertura.py con la plantilla cambiada): arma docs/loop/APERTURA_CIEGA.md desde .v67aud/apertura_plantilla.md, sustituyendo cada
...
out = []
for l in io.open('.v67aud/apertura_plantilla.md', encoding='utf-8'):
