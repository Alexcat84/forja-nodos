# -*- coding: utf-8 -*-
# Copia del auditor (ACTA 66) de .v64ext/pegado64.py con la cabecera del tramo cambiada a la vuelta 67 (ACTA 65 65.11).
...
i = [k for k, l in enumerate(lineas) if l.startswith('# VUELTA 67 ')][0]
tramo = lineas[i:]
...
print('bloques abiertos con `$` en el tramo de la vuelta 67 : %d' % total)
