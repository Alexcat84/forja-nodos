# Fase ciega de la 76 (copia de .v73aud/cruce_aristas.py con las rutas cambiadas): para cada arista por lectura de .v76aud/aristas_lectura.tsv, si el barrido levanto el par
...
bandeja = set(os.path.basename(f)[:-5] for f in glob.glob('cuarentena/gerber_emyth/*.json'))
