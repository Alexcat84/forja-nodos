# Fase ciega de la 76 (copia de .v73aud/vecinos_tabla.py con la lista cambiada a las 22 de la bandeja de Gerber): lee los .v76aud/vecinos_<id>.json que escribio .v76aud/barrido_uno.py y publica
