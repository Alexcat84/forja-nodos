# -*- coding: utf-8 -*-
"""ACTA 75: R8 (ACTA 72 72.11) medido sobre mi encargo de la 77 (docs/loop/PROMPT_SIGUIENTE.md) ANTES de cerrarlo. Copia de
.v75aud/normal/r8_encargo76.py con la seccion cambiada a la ACTA 75 (`75.N`). Imprime las lineas de prosa con digito o con
...
for n, l in enumerate(io.open('docs/loop/PROMPT_SIGUIENTE.md', encoding='utf-8'), 1):
    ...
    if not nums and not pals:
        ...
        continue
    sec = bool(re.search(r'`75\.\d+`', l))
    c['prosa con numero, %s seccion de la ACTA 75' % ('con' if sec else 'sin')] += 1
