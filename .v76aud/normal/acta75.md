...
encargo (`9dcaa4b`), con quien lo escribio:
    ...
    $ git log --format="%h %an %cI %s" 9dcaa4b3..a4c80681 | cut -c1-140
    a4c80681 alexcat84 2026-09-26T08:59:31-04:00 Apertura ciega de la vuelta 1, sellada antes de exponer el reporte
    45e46d54 alexcat84 2026-09-26T08:09:12-04:00 Vuelta 76: la salida del hook del commit del cierre
    dfca777d alexcat84 2026-09-26T08:08:19-04:00 Vuelta 76, TAREA 5: el cierre (censo igual al abrir y al cerrar, 22 fichas de Gerber preparadas
    a0d42852 alexcat84 2026-09-26T07:56:56-04:00 Vuelta 76, TAREA 3 y 4: el barrido de las 22 de Gerber (22 de 22, 54 pares, recogido dentro del
    b0dda029 alexcat84 2026-09-26T07:08:54-04:00 Vuelta 76, TAREA 1 y 2: los registros de la ACTA 74 y la fidelidad entera de las 22 fichas de G
    2407dbb0 alexcat84 2026-09-26T06:45:48-04:00 Vuelta 76: lo pendiente del arnes antes de tocar nada
    57db4ac1 alexcat84 2026-09-26T06:45:00-04:00 Paradas: dictamen de la parada del 26 sep 2026 (Grove entro entero y el tablero no lo veia), co
    ccf9498f alexcat84 2026-09-26T06:44:59-04:00 Tablero: un libro COSECHADO que ya entro entero sale INSERTADO (la vuelta 76 no abrio, 26 sep 2
    $ git diff --name-only 9dcaa4b3 45e46d54 | grep -v "^\.v76ext/" | sed "s|/[^/]*\.json$|/*.json|" | sort | uniq -c
          6 cuarentena/gerber_emyth/*.json
          2 docs/loop/*.json
          1 docs/loop/loop.log
          1 docs/loop/paradas/2026-09-26-grove-entro-entero-y-el-tablero-no-lo-veia-DICTAMEN.md
          1 docs/loop/REPORTE.md
          1 docs/loop/TABLERO.jsonl
          1 src/tablero.py
          1 tests/test_aceptacion.py
    $ git diff --name-only 45e46d54 a4c80681
    docs/loop/APERTURA_CIEGA.md
    docs/loop/SELLOS_APERTURA.jsonl
    $ git log --format="%h %an" 9dcaa4b3..a4c80681 -- src tests scripts forja.py config esquema fuentes dataset bitacora censos
    ccf9498f alexcat84
    $ git diff --stat 9dcaa4b3 45e46d54 -- src tests
     src/tablero.py           | 12 ++++++++++++
...
`.v64aud/normal/bloques_mudos.py`, no de las suyas, con la cabecera cambiada a la `76`:
    ...
    $ python .v76aud/normal/pegado76_aud.py; python .v76aud/normal/bloques_mudos76_aud.py
    bloques abiertos con `$` en el tramo de la vuelta 76 : 30
    bloques que ROMPEN R1 (ACTA 60 60.15)                : 0
    bloques abiertos con `$`: 19 | comandos `$`: 30 | comandos sin ninguna linea de salida en su bloque: 0
...
## 75.1. **LO QUE VERIFICO, CON MIS PROPIOS COMANDOS** (`1.1`)
    ...
    $ git diff --stat 9dcaa4b3 a4c80681 -- dataset bitacora censos config/pares_mutuos.jsonl | wc -l
    0
...
**EL CIERRE ESTRICTO, CORRIDO POR MI**, en serie despues de la suite, con `procesos/` vacio al terminar (bloque de arriba):
    ...
    264:TALLADO VERDE: las 157 tabla(s) comprobables son las de su instrumento, celda a celda.
    266:CENSO DE RUTAS (D.42): la unidad de la ruta es la celda
    270:  CAEN                      : 0
    276:CENSO VERDE: las 1061 rutas publicadas sostienen lo que dicen sostener.
    278:TABLA DE CIERRE DE TAREAS (D.52): toda tabla del reporte declara su instrumento
    288:TABLA DE CIERRE VERDE: ninguna celda medible difiere del dato.
    467:CIERRE VERDE: las cuatro guardas que muerden, el tallado y el censo. La vigencia corrio y publico su cuenta arriba: es cola, no guarda (D.15).
    rc=0
...
**LO QUE REPRODUZCO DE SU TRAMO**, corriendo sus instrumentos contra sus salidas guardadas con `diff`, y su huella contra mi barrido:
    ...
    contar_fidelidad.py: IDENTICO a .v76ext/contar_fidelidad.txt
    r9.py: IDENTICO a .v76ext/r9.txt
    citas.sh: IDENTICO a .v76ext/citas_fidelidad.txt
    comprobar_veredictos.py: IDENTICO a .v76ext/comprobar_veredictos.txt
    orden.py: IDENTICO a .v76ext/orden.txt
    tabla_vecinos.py: IDENTICO a .v76ext/tablas_vecinos.md
    censo.sh: IDENTICO a .v76ext/censo_cierre.txt
    validar.py con las 22 de .v76aud/las22.txt: IDENTICO a .v76ext/validar.txt
    $ cat .v76aud/normal/huellas.txt
    $ sha1sum -c --quiet .v76aud/huellas_al_barrer.txt && echo "las 42 fichas de las dos bandejas y el grafo: las mismas huellas que al barrer en mi fase ciega"
    las 42 fichas de las dos bandejas y el grafo: las mismas huellas que al barrer en mi fase ciega
    $ python .v76ext/pasos_y_huellas.py | diff - .v76ext/pasos_y_huellas.txt && echo "pasos_y_huellas.py de hoy: IDENTICO a su salida del cierre"
    pasos_y_huellas.py de hoy: IDENTICO a su salida del cierre
    $ for f in $(awk "NR<=22{print \$2}" .v76ext/pasos_y_huellas.txt); do git hash-object cuarentena/gerber_emyth/$f.json | cut -c1-10; done | diff - <(awk "NR<=22{print \$6}" .v76ext/pasos_y_huellas.txt) && echo "las 22 huellas que publica son los blobs de hoy, fila a fila"
    las 22 huellas que publica son los blobs de hoy, fila a fila
    $ git diff --stat 2407dbb0 45e46d54 -- cuarentena/ | tail -1
...
publica `9` en siete sitios:
    ...
    L13+65266: `9` PUENTE de `176`, corregido
    L169+65266: `9` PUENTE, corregidos en la b
    L233+65266: Con los `9` corregidos
    L234+65266: `9` de `176`
    L448+65266: Los `9` corregidos
    L494+65266: `9` `P`
    L558+65266: `9` PUENTE corregidos en la ba
...
`3`); la suya, el texto de AL ABRIR:
    ...
    filas suyas: 176 | mias: 176 | en las dos: 176 | solo suyas: [] | solo mias: []
    marca suya, marca mia: {('T', 'T'): 167, ('P', 'T'): 8, ('T', 'D'): 1} | suma: 176
      DIFIEREN aplicar_ocho_reglas_juego_personas paso 8 | suya P L163 | mia T L161
      DIFIEREN aplicar_ocho_reglas_juego_personas paso 9 | suya P L165 | mia T L165
      DIFIEREN cambiar_saludo_cliente_dos_ramas paso 1 | suya P L51 | mia T L51
      DIFIEREN cambiar_saludo_cliente_dos_ramas paso 2 | suya P L53 | mia T L53
      DIFIEREN cambiar_saludo_cliente_dos_ramas paso 3 | suya P L55 | mia T L55
      DIFIEREN cuantificar_impacto_innovacion_6_pasos paso 4 | suya T L95 | mia D L95
      DIFIEREN cuantificar_impacto_innovacion_6_pasos paso 6 | suya P L95 | mia T L95
      DIFIEREN dictar_ritmo_crecimiento_preguntas_escritas paso 8 | suya P L287 | mia T L287
      DIFIEREN operar_modelo_gente_destreza_minima paso 4 | suya P L89 | mia T L89
    sus P por ficha: {'aplicar_ocho_reglas_juego_personas': 2, 'dictar_ritmo_crecimiento_preguntas_escritas': 1, 'operar_modelo_gente_destreza_minima': 1, 'cambiar_saludo_cliente_dos_ramas': 3, 'cuantificar_impacto_innovacion_6_pasos': 1} | suma: 8
...
**`R9`, SU PATRON Y EL MIO SOBRE LOS `176` PASOS DE HOY**, leidos de sus ficheros y no copiados:
    ...
    pasos: 176 | por patron que casa: {'ninguno': 147, 'suyo+mio': 8, 'suyo': 21} | suma: 176
...
**`PASOS INVENTADOS POR CAPITULO`**, contado por mi desde los dos ficheros, con el titulo de cada capitulo leido de su fichero:
    ...
    cap_04 | The Entrepreneur the Manager, and the Technician | candidatos 1 | pasos 7 | PUENTE sobre el texto de al abrir 0 = 0,00 por ciento | PUENTE en el texto de hoy 0
    cap_07 | Beyond the Comfort Zone | candidatos 1 | pasos 8 | PUENTE sobre el texto de al abrir 1 = 12,50 por ciento | PUENTE en el texto de hoy 0
    cap_08 | Maturity and the Entrepreneurial Perspective | candidatos 2 | pasos 17 | PUENTE sobre el texto de al abrir 0 = 0,00 por ciento | PUENTE en el texto de hoy 0
    cap_11 | Working On Your Business, Not In It | candidatos 6 | pasos 57 | PUENTE sobre el texto de al abrir 1 = 1,75 por ciento | PUENTE en el texto de hoy 0
    cap_12 | The Business Development Process | candidatos 3 | pasos 12 | PUENTE sobre el texto de al abrir 4 = 33,33 por ciento | PUENTE en el texto de hoy 0
    cap_13 | Your Business Development Program | candidatos 1 | pasos 10 | PUENTE sobre el texto de al abrir 0 = 0,00 por ciento | PUENTE en el texto de hoy 0
    cap_14 | Your Primary Aim | candidatos 1 | pasos 9 | PUENTE sobre el texto de al abrir 0 = 0,00 por ciento | PUENTE en el texto de hoy 0
    cap_15 | Your Strategic Objective | candidatos 1 | pasos 5 | PUENTE sobre el texto de al abrir 0 = 0,00 por ciento | PUENTE en el texto de hoy 0
    cap_18 | Your People Strategy | candidatos 3 | pasos 26 | PUENTE sobre el texto de al abrir 2 = 7,69 por ciento | PUENTE en el texto de hoy 0
    cap_19 | Your Systems Strategy | candidatos 3 | pasos 25 | PUENTE sobre el texto de al abrir 0 = 0,00 por ciento | PUENTE en el texto de hoy 0
    lote: pasos 176 | PUENTE al abrir 8 = 4,55 por ciento | PUENTE hoy 0 | suma de pasos por capitulo: 176
...
**Su barrido contra el mio sellado, fila dirigida a fila dirigida, y sus lineas contra mis clases selladas, par a par:**
    ...
    (1) filas dirigidas suyas: 54 | mias: 54 | {'en las dos, igual': 54} | suma: 54
        poblacion (grafo, bandejas) suya y mia por candidato: {'((437, 42), (437, 42))': 22} | suma: 22
    (2) lineas suyas: 54 | con DISCUTIBLE: 12 | las mismas filas dirigidas que mi barrido: True
       DISTINTA aplicar_cinco_pasos_proceso_contratacion ~ construir_estrategia_gente_cuatro_componentes | suya SANO  | mia CONTINUA construir_estrategia_gente_cuatro_componentes
       DISTINTA construir_estrategia_gente_cuatro_componentes ~ aplicar_cinco_pasos_proceso_contratacion | suya SANO  | mia CONTINUA construir_estrategia_gente_cuatro_componentes
       DISTINTA construir_estrategia_gente_cuatro_componentes ~ recorrer_siete_pasos_programa_desarrollo_negocio | suya SANO  | mia CONTINUA recorrer_siete_pasos_programa_desarrollo_negocio
       DISTINTA recorrer_siete_pasos_programa_desarrollo_negocio ~ construir_estrategia_gente_cuatro_componentes | suya SANO  | mia CONTINUA recorrer_siete_pasos_programa_desarrollo_negocio
        sus clases: {'SANO': 50, 'CONTINUA': 4} | suma: 54
        contra mis clases: {'DISTINTA': 4, 'igual clase y madre': 50} | suma: 54
    $ cat .v76aud/normal/cifras_barrido.txt
    filas dirigidas por sede: {'bandeja': 44, 'grafo': 10} | suma: 54
    las de bandeja: {'de las 22': 44} | suma: 44
    vecinos del grafo por veces: {'responder_primer_aviso_renuncia_subordinado': 4, 'entregar_evaluacion_desempeno_tres_claves': 2, 'recorrer_trece_elementos_proceso_evaluacion_formal': 1, 'pedir_critica_anonima_curso_entrenamiento_dictado': 1, 'descubrir_motivacion_sentido_persona': 1, 'planificar_tres_pasos_demanda_estado_brecha': 1} | suma: 10
    candidatos sin vecinos: ['aplicar_ocho_reglas_juego_personas', 'fingir_prototipo_cinco_mil_replicas'] | filas dirigidas con similitud_texto > 0,4: 13 | del grafo levantadas solo por la senial 3: ['descubrir_motivacion_sentido_persona']
...
esta acta cambia (su `D.37` a `documentar`, y las dos de la conjunta):
    ...
    filas de su orden: 22
      19 construir_estrategia_gente_cuatro_componentes           antes que 22 aplicar_cinco_pasos_proceso_contratacion                mi CONTINUA, 75.4 relectura conjunta la cumple
      17 aplicar_seis_pasos_sistema_venta                        antes que 18 medir_sistema_venta_trece_indicadores_benchmark         CONTINUA de los dos                  la cumple
      10 cambiar_saludo_cliente_dos_ramas                        antes que 12 cuantificar_impacto_innovacion_6_pasos                  CONTINUA de los dos                  la cumple
      13 recorrer_siete_pasos_programa_desarrollo_negocio        antes que 19 construir_estrategia_gente_cuatro_componentes           D.37 de los dos                      la cumple
       5 fingir_prototipo_cinco_mil_replicas                     antes que  6 dar_valor_constante_cuatro_publicos                     D.37 de los dos                      la cumple
       5 fingir_prototipo_cinco_mil_replicas                     antes que  8 operar_modelo_gente_destreza_minima                     D.37 de los dos                      la cumple
       5 fingir_prototipo_cinco_mil_replicas                     antes que 20 documentar_trabajo_manual_operaciones                   D.37 de los dos                      la cumple
       5 fingir_prototipo_cinco_mil_replicas                     antes que  9 unificar_color_forma_vestuario_modelo                   D.37 de los dos                      la cumple
       5 fingir_prototipo_cinco_mil_replicas                     antes que 13 recorrer_siete_pasos_programa_desarrollo_negocio        mi D.29, 75.4 relectura conjunta     la cumple
      19 construir_estrategia_gente_cuatro_componentes           antes que 20 documentar_trabajo_manual_operaciones                   su D.37 (D76.14), 75.4               la cumple
      14 responder_8_preguntas_construir_primary_aim             antes que 19 construir_estrategia_gente_cuatro_componentes           mi D.29 sellada, que cae en 75.4     la cumple
      15 responder_4_preguntas_estandares_objetivo_estrategico   antes que 19 construir_estrategia_gente_cuatro_componentes           mi D.29 sellada, que cae en 75.4     la cumple
       5 fingir_prototipo_cinco_mil_replicas                     antes que 22 aplicar_cinco_pasos_proceso_contratacion                D.36 de un solo lado                 la cumple
      18 medir_sistema_venta_trece_indicadores_benchmark         antes que 19 construir_estrategia_gente_cuatro_componentes           D.36 de un solo lado                 la cumple
       7 interrogar_negocio_cinco_preguntas                      antes que  8 operar_modelo_gente_destreza_minima                     D.36 de un solo lado                 la cumple
       6 dar_valor_constante_cuatro_publicos                     antes que 11 probar_traje_azul_seis_semanas                          D.36 de un solo lado                 la cumple
    restricciones: 16 | {'la cumple': 16} | suma: 16
...
Al abrir, y despues de anotar mi tanda:
    ...
    $ sed -n '5,12p' .v76aud/normal/credito_abrir.txt
      ...
      ----------------------------------------------------------------------
      AUDITOR            1 de 3     ACTA 74
      CIFRA PUBLICADA    0 de 2     ACTA 74
      CLASE              0 de 2     ACTA 74
      DATO MOVIDO        0 de 2     ACTA 74
      REPORTE            0 de 3     ACTA 74
...
## 75.8. **EL COSTE** (`D.55`)
    ...
    $ python .v76aud/normal/coste.py
    ultimo_extractor.json | USD 15.97 | 1555 s de API | turnos 142 | entrada 282 | cache escrita 480554 | cache leida 43311897 | salida 172892 (pensamiento 59799)
    ultimo_apertura.json | USD 11.00 | 1092 s de API | turnos 103 | entrada 196 | cache escrita 433609 | cache leida 26005317 | salida 116398 (pensamiento 40755)
    $ sed -n "8380p;8384p" docs/loop/loop.log
    [2026-09-26 08:09:51] extractor listo (USD 15.965779399999997), 5070s, intento 1 de 7
    [2026-09-26 08:59:01] auditor ciego listo (USD 10.998679400000004), 2949s, intento 1 de 7
...
arranco el 25 a las `21:43`, donde la `73` es su `VUELTA 2`:
    ...
    [2026-09-26 01:54:03] VUELTA 2 : EXTRACTOR (claude-opus-5-5, esfuerzo high)
...
| campania consumada | **NO**: quedan Gerber y Marquet, abajo | |
    ...
    $ sed -n '11,13p;24p' .v76aud/normal/tablero.txt
      ...
      MUNDO 11: faltan 2 de 7 libros del corte (gerber_emyth, marquet_turn_the_ship)
