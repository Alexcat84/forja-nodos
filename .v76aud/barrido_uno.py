# -*- coding: utf-8 -*-
"""Barrido D.38.4 de la fase ciega de la 76 (copia de .v73aud/barrido_uno.py con la ruta y el libro cambiados): la ficha de
cuarentena/gerber_emyth/ o, con segundo argumento 'ins', de _insertados, normalizada como la
...
No escribe nada fuera de .v76aud/."""
import io, json, sys
sys.path.insert(0, '.')
from src import aduana, comun, config as modulo_config
i = sys.argv[1]
sede = 'cuarentena/_insertados/gerber_emyth/' if sys.argv[2:] == ['ins'] else 'cuarentena/gerber_emyth/'
...
json.dump(salida, io.open('.v76aud/vecinos_%s.json' % i, 'w', encoding='utf-8'), ensure_ascii=False, indent=1)
