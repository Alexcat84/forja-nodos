# Fase ciega de la 76 (copia de .v73aud/cruce_clases.py con las rutas cambiadas): comprueba que cada par sin orden de .v76aud/vecinos_tabla.txt tiene su fila en
# .v76aud/mis_clases.tsv y cada fila su par, y cuenta las clases con su suma (R7). Solo lee.
