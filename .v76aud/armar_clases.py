# -*- coding: utf-8 -*-
"""Fase ciega de la 76 (copia de .v73aud/armar_clases.py con las rutas cambiadas): arma
.v76aud/mis_clases.tsv, una fila por par sin orden que levanta mi barrido de las 22 (.v76aud/vecinos_<id>.json), con la clase
que YO escribi: de .v76aud/clases_intra.txt (pares dentro de un mismo capitulo, escritos antes de mirar el barrido) o de
.v76aud/clases_fuera.txt (pares entre capitulos de la tanda o con un extremo fuera, leidos al recogerlo). Solo escribe ese
...
ab = {}; fuente = {}
for l in io.open('.v76aud/clases_intra.txt', encoding='utf-8'):
    if l.startswith('@'):
