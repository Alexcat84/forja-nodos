# Fase ciega de la 70 (copia de .v69aud/generar_apertura.py con la ruta cambiada y PYTHONIOENCODING fijado): arma
# docs/loop/APERTURA_CIEGA.md desde .v70aud/apertura_plantilla.md, sustituyendo cada linea @@RUN:<n>:<fichero>:<comando>@@
...
out = []
for l in io.open('.v70aud/apertura_plantilla.md', encoding='utf-8'):
