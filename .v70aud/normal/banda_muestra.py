# ACTA 69: la muestra pineada de los SANO de la 70 (semilla 70, .v70aud/normal/muestra_sano.py), copia de .v67aud/normal/banda_muestra.py, su tasa y su banda de Wilson al 95.
# Y D.8: ningun SANO de la vuelta sin razon escrita.
import json, math
L = [json.loads(l) for l in open("bitacora/VEREDICTOS.jsonl", encoding="utf-8")][904:]
