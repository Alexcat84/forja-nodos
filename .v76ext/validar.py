# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 76 de .v64ext/validar.py, con la bandeja cambiada a cuarentena/gerber_emyth/ y la salida al formato de
...
for i in sys.argv[1:]:
    bruto = comun.leer_json('cuarentena/gerber_emyth/%s.json' % i)
