# -*- coding: utf-8 -*-
"""COPIA DE LA VUELTA 76 de .v75ext/r9.py (R9 de la ACTA 73 seccion 73.11), con la poblacion cambiada: no un nodo del grafo sino
...
for i, n, marca, linea, nota in filas:
    ...
    t += 1
    if i not in fichas:
        fichas[i] = json.load(io.open('cuarentena/gerber_emyth/%s.json' % i, encoding='utf-8'))['pasos_accionables']
    p = fichas[i][int(n) - 1]
