# -*- coding: utf-8 -*-
"""PASOS INVENTADOS POR CAPITULO (AUDITOR_FORJA.md 8.3), VUELTA 33.

Es el instrumento de la vuelta 32 (`.v32/pasos_inventados.py`) apuntado a `cap_08`:
...
(`D.30`), y aqui viene de `.v33/fidelidad.py`, que es donde esta la relectura paso a paso
con su cita pegada y comprobada contra el libro.

LA TANDA NO SE TECLEA DOS VECES: se importa de `.v33/fidelidad.py`, asi que una tanda y
