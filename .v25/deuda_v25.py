# -*- coding: utf-8 -*-
"""LA DEUDA DE ARISTAS: CUALES TIENEN LOS DOS EXTREMOS VIVOS, MEDIDO Y NO SUPUESTO.

TAREA 3 del encargo: mide primero, cablea despues. Si sale 0, se publica 0 CON EL
COMANDO AL LADO, porque una cifra de cero medida no es lo mismo que una supuesta.
