# -*- coding: utf-8 -*-
"""EL FRENO DE FIDELIDAD AL CIERRE DE LA VUELTA 25, CON TRES FILAS DE HUECO CERRADAS.
...
por_cap = {}
for ruta in sorted(glob.glob('cuarentena/scott_radical_candor/*.json') + glob.glob('cuarentena/_insertados/scott_radical_candor/*.json')):
...
NUM = [
    ('cap_01', 0, 'FIRMADO por el extractor en la vuelta 25, relectura ancha, 9 de 9 TRANSCRIPCION', True),
    ('cap_03', 0, 'FIRMADO por el extractor en la vuelta 25, relectura ancha; 3 pasos salen de cap_12 y no de cap_03, y eso va aparte', True),
    ('cap_04', 8, 'FIRMADO por el extractor en la vuelta 22, leido uno a uno', True),
    ('cap_05', 1, 'FIRMADO por el extractor en la vuelta 25, relectura ancha de los 8 candidatos, 76 pasos', True),
    ...
    ('cap_14', 1, 'el puente teamwork que el auditor cazo (ACTA 24 5.2), releido y FIRMADO por mi en la vuelta 25', True),
]
...
print('candidatos del lote 4, bandeja mas insertados : %d'
