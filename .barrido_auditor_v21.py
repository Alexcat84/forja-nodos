...
objetivo = sys.argv[1]
SOLO = set(l.strip() for l in io.open('.lote_v21_auditor.txt',encoding='utf-8') if l.strip())
print("candidatos de la vuelta 21 (las cinco de cap_09) a barrer: %d" % len(SOLO), flush=True)
