# Fase ciega de la 66: comprueba que cada par sin orden de .v66aud/vecinos_tabla.txt tiene su fila en
# .v66aud/mis_clases.tsv y cada fila su par, y cuenta las clases. Solo lee.
