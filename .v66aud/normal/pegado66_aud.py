# -*- coding: utf-8 -*-
# Copia del auditor (ACTA 65) de .v64ext/pegado64.py con la cabecera del tramo cambiada a la vuelta 66 (ACTA 64 64.11).
...
i = [k for k, l in enumerate(lineas) if l.startswith('# VUELTA 66 ')][0]
tramo = lineas[i:]
...
print('bloques abiertos con `$` en el tramo de la vuelta 66 : %d' % total)
