# ACTA 65: los SANO de la 66 son menos de tres, asi que se releen todos (AUDITOR_FORJA 7), sin semilla; su tasa y su banda de Wilson al 95. Copia de .v65aud/normal/banda_muestra.py con la tanda cambiada.
# Y D.8: ningun SANO de la vuelta sin razon escrita.
import json, math
L = [json.loads(l) for l in open("bitacora/VEREDICTOS.jsonl", encoding="utf-8")][795:]
