...
@@RUN:0::git diff --stat 3174c73 HEAD -- dataset/ bitacora/ censos/ config/pares_mutuos.jsonl@@
@@RUN:0::git diff --name-status 3174c73 HEAD -- cuarentena/@@
...
@@RUN:0::python .v66aud/entra_lo_leido.py@@
...
@@RUN:0::cat .v66aud/barrido_variar_frecuencia_inspeccion_nivel_calidad.txt .v66aud/barrido_simplificar_trabajo_reducir_numero_pasos.txt@@
@@RUN:0::grep -E "^    (variar|simplificar)" .v66aud/vecinos_tabla.txt | grep ">"@@
...
@@RUN:0::wc -l fuentes/grove_high_output/cap_04.md@@
...
@@RUN:0::python .v66aud/contar_fidelidad.py@@
...
@@RUN:0::head -1 .v66aud/barrido.log; tail -1 .v66aud/barrido.log; grep -c "rc=0" .v66aud/barrido.log; grep -c "rc=" .v66aud/barrido.log@@
@@RUN:0::sha1sum -c --quiet .v66aud/huellas_bandeja_al_barrer.txt && echo "bandeja de grove: mismas huellas que al barrer"@@
@@RUN:0::cat .v66aud/head_al_barrer.txt; git rev-parse HEAD@@

**Poblacion y vecinos por candidato:**

@@RUN:28:.v66aud/vecinos_tabla.txt:python .v66aud/vecinos_tabla.py | sed -n '1,/^sin fichero/p'@@
@@RUN:0::grep ">" .v66aud/vecinos_tabla.txt | grep -Ev "^    (variar|simplificar)" | wc -l@@
@@RUN:0::grep ">" .v66aud/vecinos_tabla.txt | grep -Ev "^    (variar|simplificar)" | grep -c " grafo "@@
@@RUN:0::tail -1 .v66aud/vecinos_tabla.txt@@
@@RUN:0::grep ">" .v66aud/vecinos_tabla.txt | grep -E "^    (reunir|escalonar|programar|transmitir|empujar|subir|buscar_actividad|elegir_momento)" | wc -l@@
@@RUN:0::grep ">" .v66aud/vecinos_tabla.txt | grep -E "^    (reunir|escalonar|programar|transmitir|empujar|subir|buscar_actividad|elegir_momento)" | awk '{print $6}' | sort -n | sed -n '1p;$p'@@
@@RUN:0::grep ">" .v66aud/vecinos_tabla.txt | grep " grafo "@@
@@RUN:0::cat .v66aud/detalle_paso_notables.txt@@
...
@@RUN:0::grep "rc=" .v66aud/barrido.log | sed 's/.*segundos=//' | sort -n | sed -n '1p;$p'@@
...
@@RUN:0::python .v66aud/cruce_clases.py@@
...
@@RUN:0::python .v66aud/cruce_aristas.py@@
...
@@RUN:0::cat .v66aud/d37_partes.txt@@
...
@@RUN:0::python .v66aud/restricciones_orden.py@@
...
@@RUN:0::grep -E "^TALLADO|^tablas que declaran|Error" .v66aud/tallado_apertura.txt@@
