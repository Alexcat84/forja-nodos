...
que el auditor siguiente recomputa. La tabla va pegada de su instrumento (`D.41`), y **la cita de
cada fila la imprime el instrumento de la linea** (`D.35`).

    $ python .v53/frontera.py

### OO.2.a. `cap_06`, `Decisions, Decisions`: **TREINTA Y DOS TRAMOS Y OCHO NODOS**

<!-- TALLADO: parcial salida=.v53/frontera_tres.txt -->
